...
buttonLinkBackgroundSelected =
  "$o2BluePrimaryLight10"; /* deberíamos pasarlo a o2BlueLight10 */ // "$white alpha 0.05"
...
textLinkInverse = "$white"; // "$o2BluePrimaryLight50"
textLinkDanger = "$pepper";
textLinkDangerDisabled = "$pepperLight30"; // "$grey5"
textLinkDisabled = "$o2BluePrimaryLight50"; // "$darkModeGrey6"
...
textAppBarSelected = "$o2BluePrimary"; // "$grey2"
