...
const ProductStatus = () => {
  ...
  const componentStatuses = {
    ...
    "Meu Vivo (App)": ["Brazil", <Done />, <Done />, <Done />, <Done />],
    "Mi O2 (App)": ["Spain", <Done />, <Done />, <Done />, <Done />],
    "Mi O2 (Web)": ["Spain", <Done />, <Done />, <Done />, <Done />],
    "My O2 (App)": ["UK", <Done />, <Done />, <Done />, <Done />],
    "Mein O2 (App)": ["Germany", <Done />, <Done />, <Done />, <Done />],
    "Mein Blau (App)": ["Germany", <Done />, <Done />, <Done />, <Done />],
    "Novum CMS (Web)": ["Global", <Done />, <Done />, <Done />, <Done />],
    ...
    "TU Wallet (App)": ["Spain", <Done />, <Done />, <Done />, <Done />],
    "TU Wallet (Web)": ["Spain", <Done />, <Done />, <Pending />, <Done />],
    "TU Latch (App)": ["Spain", <Done />, <Done />, <Done />, <Done />],
    "TU Latch (Web)": ["Spain", <Done />, <Done />, <Pending />, <Done />],
    "TU.com (Web)": ["Spain", <Done />, <Done />, <Done />, <Done />],
    "Fonditel (App)": ["Spain", <Done />, <Done />, <Done />, <Done />],
    "Fonditel (Web)": ["Spain", <Done />, <Done />, <Done />, <Done />],
    ...
    "Vivo Movel": ["Brazil", <Done />, <Done />, <Done />, <Done />],
    "Vivo Seguros": ["Brazil", <Done />, <Done />, <Done />, <Done />],
    "Conexión Segura (App)": ["Spain", <Done />, <Done />, <Done />, <Done />],
    "Movistar Money (Web)": [
      "Spain",
      <Wip />,
      <Done />,
    ...
    "Opengateway Sandbox": ["Spain", <Done />, <Done />, <Done />, <Done />],
    "E-Care": ["Ecuador", <Unknown />, <Done />, <Unknown />, <Unknown />],
    Aura: ["Ecuador", <Unknown />, <Done />, <Unknown />, <Unknown />],
    "Movistar Music": ["Global", <Done />, <Pending />, <Pending />, <Done />],
    Hispam: [
      "Arg / Chile",
