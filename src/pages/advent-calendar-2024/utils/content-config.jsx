...
const contentByDate = {
  ...
  "2024-11-11": {
    ...
    title: "Wordle",
    description:
      "Press Start to begin! Follow a sequence of flashing colors, and repeat it back by pressing the buttons in the same order. Each round, the sequence grows, testing how far you can go before you lose track.",
  },
  "2024-11-12": {
    illustration: <IllustrationWoolClothes />,
    content: (
