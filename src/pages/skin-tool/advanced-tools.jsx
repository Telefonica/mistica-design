    ...
    return (
      <div 
        ...
        style={{
          ...
          padding: '12px',
          borderRadius: '8px',
          backgroundColor: selectedColor === colors[colorKey] ? 'rgba(0, 0, 0, 0.05)' : 'transparent',
          display: 'flex',
          alignItems: 'center',
          flexDirection: 'row',
          marginBottom: '16px',
      ...
      >
        ...
        />
        <div style={{ marginLeft: '16px', flexGrow: 1, display: 'flex', flexDirection:'column', gap: 4 }}>
            ...
            <div style={{ width:'280px', flexShrink: 0 }}>
             <Text2>Core palette colors</Text2>
              <div className="color-list">
                <ColorBox colorKey="brandColor" label="Brand" showEditIcon={false} />
                <ColorBox colorKey="errorColor" label="Error" showEditIcon={false} />
                <ColorBox colorKey="warningColor" label="Warning" showEditIcon={false} />
                <ColorBox colorKey="successColor" label="Success" showEditIcon={false} />
                <ColorBox colorKey="promoColor" label="Promo" showEditIcon={false} />
                <ColorBox colorKey="neutral1" label="Neutral1" showEditIcon={false} />
                <ColorBox colorKey="neutral2" label="Neutral2" showEditIcon={false} />
                <ColorBox colorKey="neutral3" label="Neutral3" showEditIcon={false} />
              </div>
            </div>
            <div style={{ display:'flex', flexDirection:'column', alignItems: 'center', width: 600, gap: '32px'}}>
              ...
              <Theme themeColors={{ ...colors, selectedColor }}>
                <div className="preview-card">
                  ...
                  >
                    ...
                    <HeaderLayout 
                      isInverse={true}
                      header={<Header headline="Hussle" title="Save on winter workouts with a free gym Day Pass" />}
                      extra={
                        <Inline space={16}>
                          <Row asset={<IconTimeRegular />} title="Ends Tue 28 Feb" />
                  ...
                  <div className="preview-content">
                    ...
                    <ButtonLayout 
                      align="full-width"
                      primaryButton={<ButtonPrimary onPress={() => {}}>Use Now</ButtonPrimary>}
                      secondaryButton={<ButtonSecondary onPress={() => {}}>Save</ButtonSecondary>}
                    />
                  </div>
                </div>
              </Theme>
