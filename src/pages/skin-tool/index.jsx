			...
			<div>
				<h1 style={{
					...
					<div style={{ display: 'flex', gap: '13px', marginTop: '20px' }}>
						<ButtonPrimary onPress={() => navigate('/create-skin')}>Start from Scratch</ButtonPrimary>
						<ButtonSecondary onPress={() => navigate('/remix-skin')}>Remix an Existing Skin</ButtonSecondary>
					</div>
