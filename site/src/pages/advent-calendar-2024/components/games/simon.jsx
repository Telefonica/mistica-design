...
const UnmuteIcon = () => (
  ...
  >
    <path
      d="M17.2 4.23367C17.45 4.09367 17.75 4.09367 18 4.24367C18.25 4.39367 18.4 4.65367 18.4 4.94367V19.0637C18.4 19.3637 18.24 19.6337 17.99 19.7737C17.87 19.8437 17.74 19.8737 17.6 19.8737C17.46 19.8737 17.31 19.8337 17.19 19.7537L10 15.6737H7.8C7.36 15.6737 7 15.3137 7 14.8637V9.11367C7 8.67367 7.36 8.30367 7.8 8.30367H9.99L17.2 4.23367Z"
      fill="#031A34"
    />
  </svg>
);
...
const SimonSays = ({ onFinish, onFinalScreen }) => {
  ...
  let currentSound = React.useRef(null);
  ...
  const checkPlayerSequence = useCallback(() => {
  ...
  }, [isGameOver, playerSequence, score, sequence, addColorToSequence]);
  ...
  }, [playerSequence, isPlaying, sequence, checkPlayerSequence]);
            ...
            <div className="simon-board">
              {colors.map((color) => (
                <div
                  ...
                  style={{
                    pointerEvents:
                      isGameOver || !isPlayerTurn ? "none" : "auto",
                  }}
                />
              ))}
            </div>
